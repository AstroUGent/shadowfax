...
import sys
if "shapy2d" in sys.modules:
  raise ImportError("2D version of shapy already loaded!\n"
                    "Loading both the 2D and 3D version leads to conflicts!")

from libpython_riemann3d import *
from libpython_io3d import *
from libpython_grid3d import *
from libpython_lloyd3d import *
...
def vec_as_string(vec):
  string = "(" + str(vec.x()) + "," + str(vec.y()) + "," + str(vec.z()) + ")"
  return string
