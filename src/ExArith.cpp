...
void ExactArithmetic::test_predicates() {
    ...
    // Test 1: should return 1
    {
        ...
        cout << "orient3d_exact: ";
        cout << orient3d_exact(a, b, c, d) << endl;
        cout << "orient3d_adaptive: ";
        cout << orient3d_adaptive(a, b, c, d) << endl;
    }
    ...
    // Test 1: should return 0.75
    {
        ...
        cout << "insphere_exact: ";
        cout << insphere_exact(a, b, c, d, e) << endl;
        cout << "insphere_adaptive: ";
        cout << insphere_adaptive(a, b, c, d, e) << endl;
    }
    ...
    // Test 1: should return 1
    {
        ...
        cout << "orient2d_exact: ";
        cout << orient2d_exact(a, b, c) << endl;
        cout << "orient2d_adaptive: ";
        cout << orient2d_adaptive(a, b, c) << endl;
    }
    // Test 2: should return -1
    {
        cout << "## Standard negative orientation ##" << endl;
    ...
    // Test 1: should return 0.5
    {
        ...
        cout << "incircle_exact: ";
        cout << incircle_exact(a, b, c, d) << endl;
        cout << "incircle_adaptive: ";
        cout << incircle_adaptive(a, b, c, d) << endl;
    }
