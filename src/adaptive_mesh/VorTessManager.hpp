...
#if ndim_ == 3
    /*! @brief Pointer to an AdaptiveVorTess3d, used for the 3D evolution
     *  algorithm */
    AdaptiveVorTess3d* _tess2;
#else
    /*! @brief Pointer to an AdaptiveVorTess, used for the 2D evolution
     *  algorithm */
    AdaptiveVorTess2d* _tess2;
#endif
